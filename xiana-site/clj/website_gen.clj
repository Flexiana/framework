...
(def config
  {:docs  "doc"
   :metas "doc/resources/meta"
   :pages [{:out     "xiana-site/content/en/docs/prologue/intro.md"
            :meta    "introduction.md"
            :content "welcome.md"}
           {:out     "xiana-site/content/en/docs/prologue/conventions.md"
            :meta    "conventions.md"
            :content "conventions.md"}
           {:out     "xiana-site/content/en/docs/prologue/tutorials.md"
            :meta    "tutorials.md"
            :content "tutorials.md"}]})

(defn append
  [doc-path meta-path page]
  (let [meta-file    (slurp (str meta-path "/" (:meta page)))
        content-file (slurp (str doc-path "/" (:content page)))]
    (str/join "\n" [meta-file content-file])))

(defn process-files)

(spit (:out (first (:pages config))) (append (:docs config) (:metas config) (first (:pages config))))
